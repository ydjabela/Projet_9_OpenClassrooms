...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('blog', '0002_rename_name_ticket_title'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='folowing', to=settings.AUTH_USER_MODEL)),
            ],
            options={
